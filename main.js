...
const starts = async (agam = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('YUI-CHAN', {
		font: 'Standard',
	...
	console.log(color('[LEON]', 'cyan'), color('Owner is online now!', 'white'))
	console.log(color('[LEON]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'white'))
	console.log(color('[LEON]', 'cyan'), color('Please Subscribe LeonGanz!', 'white'))
	console.log(color('[LEON]', 'cyan'), color('VERSION : 1.0.0', 'white'))
	agam.browserDescription = ["LEON", "chrome", "3.0.0"];
	...
	agam.on('connecting', () => {
		console.log(color('[ LEON ]', 'cyan'), color('Connecting....'));
	})

	//connect
	agam.on('open', () => {
		console.log(color('[ LEON ]', 'cyan'), color('Connected√!'));
	})
